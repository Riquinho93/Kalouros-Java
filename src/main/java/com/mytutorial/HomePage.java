...
public class HomePage extends WebPage {
	...
	public HomePage() {
		...
		add(telaPrincipal());
		/*
		 * add(bancoForm()); add(contaForm()); add(contatoForm(userName));
		 */
	...
	/*
	 * private AjaxLink<ServiceForm> bancoForm() { AjaxLink<ServiceForm> ajaxLink =
	 * new AjaxLink<ServiceForm>("bancoForm") {
	 * 
	 * private static final long serialVersionUID = 1L;
	 * 
	 * @Override public void onClick(AjaxRequestTarget target) {
	 * setResponsePage(ServiceForm.class); } }; ajaxLink.setOutputMarkupId(true);
	 * add(ajaxLink); return ajaxLink; }
	 * 
	 * private AjaxLink<ContaForm> contaForm() { AjaxLink<ContaForm> ajaxLink = new
	 * AjaxLink<ContaForm>("contaForm") {
	 * 
	 * private static final long serialVersionUID = 1L;
	 * 
	 * @Override public void onClick(AjaxRequestTarget target) {
	 * setResponsePage(ContaForm.class); } }; ajaxLink.setOutputMarkupId(true);
	 * add(ajaxLink); return ajaxLink; }
	 * 
	 * 
	 ...
	 * private static final long serialVersionUID = 1L;
	 * 
	 * @Override public void onClick(AjaxRequestTarget target) { setResponsePage(new
	 * ContatoForm(usuario)); } }; ajaxLink.setOutputMarkupId(true); add(ajaxLink);
	 * return ajaxLink; }
	 */
}
